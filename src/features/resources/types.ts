...
export type TranscriptStatus = 'idle' | 'processing' | 'completed' | 'failed'
...
export interface Resource {
  ...
  /** Full text transcript generated by ElevenLabs Scribe v2. */
  transcript: string | null
  /** Processing state of the ElevenLabs transcription job. */

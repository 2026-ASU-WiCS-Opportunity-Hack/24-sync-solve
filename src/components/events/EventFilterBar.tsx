  ...
  return (
    <div className="mb-6 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm">
      <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className={`rounded-full px-4 py-2 text-sm font-medium transition-colors disabled:cursor-wait ${
                activeType === type.value
                  ? 'bg-wial-navy text-white shadow-sm'
        ...
        {/* Upcoming / All toggle */}
        <label className="ms-auto flex cursor-pointer items-center gap-2 rounded-full border border-gray-200 px-3 py-1.5 text-sm text-gray-600">
          <input
            type="checkbox"
            checked={upcoming}
